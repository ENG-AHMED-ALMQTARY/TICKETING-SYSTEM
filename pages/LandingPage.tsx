...
import { ArrowRight, MessageSquare, Shield, Activity, Users } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.div
               ...
               className="absolute -bottom-10 -right-10 bg-indigo-600 p-4 rounded-xl shadow-xl flex items-center space-x-3"
            >
